...
On a 4:5 canvas the same page has a 1150px budget but only 920px of width, so the constraint moves: fewer things fit side by side, and long headings wrap to two or three lines. Count the wrapped lines.
